...
class account_invoice_facturae_pdf_cbb(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        super(account_invoice_facturae_pdf_cbb, self).__init__(cr, uid, name, context=context)
...
report_sxw.report_sxw(
    'report.account.invoice.facturae.pdf2.inherit',
    'account.invoice',
    'addons/sfs_multy_address_facturae/report/invoice_facturae_pdf.rml',
    header=False,
    parser=account_invoice_facturae_pdf_cbb,
)
