...
class product_product(osv.osv):
    ...
    _columns = {
                ...
                'wholesale_discount_amount': fields.related('categ_id', 'wholesale_discount_amount', type='float')
                }
...
class product_category(osv.osv):
    ...
    _columns = {
                'wholesale_discount_amount': fields.float('Wholesale Discount Amount')
                }
product_category()
