...
class account_invoice_facturae_pdf(report_sxw.rml_parse):
    def __init__(self, cr, uid, name, context):
        ...
        self.localcontext.update({
            ...
            'split_strings': self._split_strings,
        ...
        self.taxes = []
    def _split_strings(self, string, length=19):
        if string:
...
report_sxw.report_sxw(
    'report.account.invoice.facturae',
    'account.invoice',
    'addons/sfs_facturae_invoice_customization/report/invoice_facturae.rml',
    header=False,
