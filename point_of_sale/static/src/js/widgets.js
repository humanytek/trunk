...
// ---------- Main Point of Sale Widget ----------
    ...
    module.PosWidget = module.PosBaseWidget.extend({
        ...
        build_widgets: function() {
            //var self = this;
//            // --------  Screens ---------
//            myDiv = jQuery('#applet_div');
//            var attributes = { code:'JSSerial.class', archive:'JSSerial.jar',  width:100, height:100, id:'JSSerial'}; 
//            var parameters = {jnlp_href: 'http://77.243.229.249/jsserial-applet.jnlp'}; 
//            var result = deployJava.runApplet(attributes, parameters)
//            alert("Loading Serial Ports......")
//            if (document.JSSerial){
//                var serialPortList = document.JSSerial.listPorts();
//                var aSerialPortList = String(serialPortList).split(',');
//                if(aSerialPortList){
//                    test = document.JSSerial.startSerial(aSerialPortList[0]);
//                    alert(test)
//                }
//            }
