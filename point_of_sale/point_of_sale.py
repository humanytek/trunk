...
class pos_order(osv.osv):
    ...
    def add_payment(self, cr, uid, order_id, data, context=None):
        ...
        statement_obj = statement_obj.browse(cr, uid, statement_id, context=context)
        statement_line_length = len(statement_obj.line_ids)
        args['statement_id'] = statement_id
        args['sequence'] = statement_line_length + 1
